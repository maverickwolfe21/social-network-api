...
module.exports = {
  ...
  async createThought(req, res) {
    try {
      ...
      const updatedUser = await User.findOneAndUpdate({ _id: req.body.userId }, { $push: { thoughts: dbThoughtData._id } }, { new: true });
  ...
  async addReaction(req, res) {
    try {
      ...
      const updatedThought = await Thought.findOneAndUpdate({ _id: req.params.thoughtId }, { $push: { reactions: dbReactionData } }, { new: true });
      if (!updatedThought) {
